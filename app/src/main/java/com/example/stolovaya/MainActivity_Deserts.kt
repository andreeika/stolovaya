...
class MainActivity_Deserts : AppCompatActivity(), CustomAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_main_deserts)
        ...
        button_korzina = findViewById(R.id.button3)
        ...
        logoBack.setOnClickListener {
            val intent = Intent(this@MainActivity_Deserts, MainActivity::class.java)
            startActivity(intent)
        }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                if (connect != null) {
                    val query: String = "exec categoriesDivision 6"
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        Toast.makeText(this@MainActivity_Deserts, connectionResult, Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (ex: Exception) {
                withContext(Dispatchers.Main) {
