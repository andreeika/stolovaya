...
class MainActivity_Napitki : AppCompatActivity(), CustomAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_main_napitki)
        ...
        logoBack.setOnClickListener {
            val intent = Intent(this@MainActivity_Napitki, MainActivity::class.java)
            startActivity(intent)
        }

        button_korzina = findViewById(R.id.button6)

        button_korzina.setOnClickListener {
            val intent = Intent(this@MainActivity_Napitki, MainActivity_Korzina::class.java)
            startActivity(intent)
        }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                if (connect != null) {
                    val query: String = "exec categoriesDivision 10"
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        Toast.makeText(this@MainActivity_Napitki, connectionResult, Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (ex: Exception) {
                withContext(Dispatchers.Main) {
