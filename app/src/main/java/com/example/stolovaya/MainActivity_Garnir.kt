...
class MainActivity_Garnir : AppCompatActivity(), CustomAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        logoBack.setOnClickListener {
            val intent = Intent(this@MainActivity_Garnir, MainActivity::class.java)
            startActivity(intent)
        }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                if (connect != null) {
                    val query: String = "exec categoriesDivision 2"
