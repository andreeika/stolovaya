...
class MainActivity_Zavtrak : AppCompatActivity(), CustomAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_main_zavtrak)
        ...
        logoBack.setOnClickListener {
            val intent = Intent(this@MainActivity_Zavtrak, MainActivity::class.java)
            startActivity(intent)
        }

        button_korzina = findViewById(R.id.button9)

        button_korzina.setOnClickListener {
            val intent = Intent(this@MainActivity_Zavtrak, MainActivity_Korzina::class.java)
            startActivity(intent)
        }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                if (connect != null) {
                    val query: String = "exec categoriesDivision 8"
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        Toast.makeText(this@MainActivity_Zavtrak, connectionResult, Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (ex: Exception) {
                withContext(Dispatchers.Main) {
