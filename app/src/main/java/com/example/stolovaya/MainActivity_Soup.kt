...
class MainActivity_Soup : AppCompatActivity(), CustomAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_main_soup)
        ...
        button_korzina = findViewById(R.id.button8)

        button_korzina.setOnClickListener {
            val intent = Intent(this@MainActivity_Soup, MainActivity_Korzina::class.java)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                if (connect != null) {
                    val query: String = "exec categoriesDivision 1"
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        Toast.makeText(this@MainActivity_Soup, connectionResult, Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (ex: Exception) {
                withContext(Dispatchers.Main) {
        ...
        logoBack.setOnClickListener {
            val intent = Intent(this@MainActivity_Soup, MainActivity::class.java)
            startActivity(intent)
        }
    }
