...
class MainActivity_Bulochki : AppCompatActivity(), CustomAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        logoBack.setOnClickListener {
            val intent = Intent(this@MainActivity_Bulochki, MainActivity::class.java)
            startActivity(intent)
        }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                if (connect != null) {
                    val query: String = "exec categoriesDivision 5"
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        Toast.makeText(this@MainActivity_Bulochki, connectionResult, Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (ex: Exception) {
                withContext(Dispatchers.Main) {
